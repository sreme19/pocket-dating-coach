  ...
  const questions: Question[] = [
    {
      ...
      question: '💍 Which best describes your journey so far?',
      options: [
        { value: 'divorced', label: '📋 Divorced' },
        { value: 'widowed', label: '🕊️ Widowed' },
        { value: 'separated', label: '🤝 Separated' },
        { value: 'prefer_later', label: '❤️ Prefer to share later' }
      ]
    },
    {
      id: 'emotional_state',
      type: 'multiple-choice',
      question: '🌤️ How would you describe yourself emotionally today?',
      options: [
        { value: 'healed_ready', label: '❤️ Healed and ready' },
        { value: 'still_growing', label: '🌱 Still growing, but open' },
        { value: 'grounded_aware', label: '🧘 Grounded and emotionally aware' },
        { value: 'hopeful', label: '✨ Hopeful about love again' }
      ]
    },
    {
      id: 'life_values',
      ...
      options: [
        { value: 'emotional_peace', label: '❤️ Emotional peace' },
        { value: 'loyalty_reliability', label: '🤝 Loyalty and reliability' },
        { value: 'honest_communication', label: '💬 Honest communication' },
        { value: 'family_stability', label: '👨‍👩‍👧‍👦 Family and stability' },
        { value: 'emotional_maturity', label: '🧠 Emotional maturity' },
        { value: 'kindness_patience', label: '😊 Kindness and patience' },
        { value: 'shared_experiences', label: '🌍 Shared life experiences' }
      ]
    },
    {
      id: 'conflict_perspective',
      type: 'multiple-choice',
      question: '💬 How do you approach conflict differently now?',
      options: [
        { value: 'calm_communication', label: '🧘 I value calm communication' },
        { value: 'repair_not_winning', label: '🤝 I focus on repair, not winning' },
        { value: 'avoid_drama', label: '💭 I avoid unnecessary drama' },
        { value: 'understanding_each_other', label: '❤️ I care more about understanding each other' }
      ]
    },
    {
      id: 'relationship_energy',
      type: 'multiple-choice',
      question: '✨ What kind of relationship are you hoping to build now?',
      options: [
        { value: 'stable_dependable', label: '🧱 Stable and dependable' },
        { value: 'emotionally_safe', label: '❤️ Emotionally safe and loving' },
        { value: 'deep_companionship', label: '🌍 Deep companionship' },
        { value: 'healthier_love', label: '🌱 A healthier version of love than before' }
      ]
    }
  ];
...
<div class="second-chapter-profile-step">
...
<style>
  ...
  @media (max-width: 767px) {
    .second-chapter-profile-step { gap: 1rem; }
