  ...
  const questions: Question[] = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'professional', label: '⚕️ Professional degree (MD, LLB, CA…)' },
        { value: 'prefer_not', label: '🤐 Prefer not to say' }
      ]
    },
    {
      id: 'own_lifestyle',
      type: 'multi-select',
      question: '🌿 Which lifestyle choices describe you?',
      ...
      options: [
        ...
        { value: 'fitness', label: '💪 Health & fitness focused' }
      ]
    },
    {
      id: 'own_income',
...
<div class="matrimony-profile-step">
  <!-- Header -->
...
<style>
  ...
  @media (max-width: 767px) {
    .matrimony-profile-step { gap: 1rem; }
