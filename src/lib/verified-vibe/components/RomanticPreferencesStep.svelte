  ...
  const questions: Question[] = [
    {
      ...
      question: '❤️ What kind of emotional energy attracts you most?',
      options: [
        { value: 'warm_open', label: '🫶 Warm and emotionally open' },
        { value: 'romantic_expressive', label: '🌹 Romantic and expressive' },
        { value: 'stable_dependable', label: '🧱 Stable and dependable' },
        { value: 'passionate_intense', label: '🔥 Passionate and intense' }
      ]
    },
    {
      id: 'communication_expectation',
      type: 'multiple-choice',
      question: '💬 What kind of communication feels right to you?',
      options: [
        { value: 'frequent_affectionate', label: '💌 Frequent and affectionate' },
        { value: 'balanced_present', label: '😊 Balanced but emotionally present' },
        { value: 'slow_natural', label: '🌱 Slow and natural' },
        { value: 'honest_consistent', label: '🤝 Honest and consistent' }
      ]
    },
    {
      ...
      options: [
        { value: 'doing_life_together', label: '🌍 Doing life together' },
        { value: 'safe_space', label: '💞 Being each other\'s safe space' },
        { value: 'romantic_dates', label: '🌹 Romantic dates and thoughtful effort' },
        { value: 'emotional_intimacy', label: '🫶 Emotional intimacy' },
        { value: 'strong_chemistry', label: '🔥 Strong chemistry' },
        { value: 'playfulness', label: '😂 Playfulness and laughter' },
        { value: 'real_love_story', label: '📖 A real love story' }
      ]
    },
    {
      id: 'partner_availability',
      type: 'multiple-choice',
      question: '⏳ What matters most in a partner emotionally?',
      options: [
        { value: 'emotional_availability', label: '❤️ Emotional availability' },
    ...
    },
    {
      id: 'future_romance',
      type: 'multiple-choice',
      question: '💫 Ideally, where would you like love to lead?',
      options: [
        { value: 'deeply_committed', label: '❤️ A deeply committed relationship' },
        { value: 'marriage_eventually', label: '💍 Marriage eventually' },
        { value: 'meaningful_long_term', label: '🌱 A meaningful long-term connection' },
        { value: 'something_real', label: '✨ I just want something real' }
      ]
    },
    {
      id: 'ideal_partner_description',
      type: 'text',
      question: '💝 Describe the kind of person your heart naturally falls for.',
      placeholder: 'Describe the kind of person your heart naturally falls for…',
      optional: true
    }
  ];
...
<div class="romantic-prefs-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      ...
      <p class="subtitle">
        {step === 'questions'
          ? 'Tell us who your heart falls for'
