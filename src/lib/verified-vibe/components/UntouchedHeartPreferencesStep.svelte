  ...
  const questions: Question[] = [
    {
      ...
      question: '🌿 What kind of person makes you feel most comfortable?',
      options: [
        { value: 'patient_understanding', label: '😊 Patient and understanding' },
        { value: 'emotionally_warm', label: '❤️ Emotionally warm' },
        { value: 'honest_communicative', label: '💬 Honest and communicative' },
        { value: 'calm_dependable', label: '🤝 Calm and dependable' }
      ]
    },
    {
      id: 'partner_approach',
      type: 'multiple-choice',
      question: '⏳ How would you like someone to approach the relationship?',
      options: [
        { value: 'slowly_intentionally', label: '🌱 Slowly and intentionally' },
        { value: 'genuine_conversation', label: '💬 Through genuine conversation' },
        { value: 'emotional_reassurance', label: '❤️ With emotional reassurance' },
        { value: 'building_trust', label: '🤝 By building trust naturally' }
      ]
    },
    {
      id: 'ideal_relationship',
      type: 'multi-select',
      question: '💝 What kind of relationship do you dream about?',
      subtitle: 'Select all that apply',
      options: [
        { value: 'emotionally_safe', label: '🌿 Feeling emotionally safe together' },
        { value: 'deeply_understood', label: '❤️ Being deeply understood' },
        { value: 'simple_meaningful_moments', label: '😊 Sharing simple meaningful moments' },
        { value: 'growing_slowly', label: '🤝 Growing together slowly' },
        { value: 'talking_openly', label: '💬 Talking about everything openly' },
        { value: 'first_love_sincerely', label: '✨ Experiencing love sincerely for the first time' },
        { value: 'peaceful_connection', label: '🫶 A peaceful emotional connection' }
      ]
    },
    {
      id: 'partner_trait_priority',
      type: 'multiple-choice',
      question: '✨ What quality matters most to you in a partner?',
      options: [
        { value: 'emotional_kindness', label: '❤️ Emotional kindness' },
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: '🌅 Ideally, where would you like this kind of connection to lead?',
      options: [
        { value: 'meaningful_relationship', label: '❤️ A meaningful relationship' },
        { value: 'long_term_commitment', label: '💍 Long-term commitment eventually' },
        { value: 'real_develops_naturally', label: '🌱 Something real that develops naturally' },
        { value: 'deep_emotional_partnership', label: '🤝 A deep emotional partnership' }
      ]
    },
    {
      id: 'ideal_partner_description',
      type: 'text',
      question: '💌 Describe the kind of person you\'d feel safe opening your heart to.',
      placeholder: 'Describe the kind of person you\'d feel safe opening your heart to…',
      optional: true
    }
  ];
...
<div class="untouched-heart-prefs-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      ...
      <p class="subtitle">
        {step === 'questions'
          ? 'Tell us what kind of person you\'re hoping to find'
...
<style>
  ...
  @media (max-width: 767px) {
    .untouched-heart-prefs-step { gap: 1rem; }
