  ...
  const questions: Question[] = [
    {
      ...
      question: '🌱 How would you describe your dating journey so far?',
      options: [
        { value: 'very_little', label: '😊 Very little dating experience' },
        { value: 'few_connections', label: '💭 I\'ve had a few meaningful connections' },
        { value: 'taken_slowly', label: '🌿 I\'ve taken relationships slowly' },
        { value: 'new_to_intentional', label: '❤️ I\'m new to intentionally dating' }
      ]
    },
    {
      id: 'relationship_pace',
      type: 'multiple-choice',
      question: '⏳ What pace feels most comfortable to you?',
      options: [
        { value: 'slow_intentional', label: '🌱 Slow and intentional' },
        { value: 'naturally', label: '😊 Getting to know someone naturally' },
        { value: 'emotional_first', label: '❤️ Emotional connection before anything serious' },
        { value: 'step_by_step', label: '🤝 Taking things step by step' }
      ]
    },
    {
      id: 'dating_energy',
      type: 'multiple-choice',
      question: '✨ What feels most important to you while dating?',
      options: [
        { value: 'emotional_safety', label: '❤️ Feeling emotionally safe' },
        { value: 'genuine_conversations', label: '💬 Genuine conversations' },
        { value: 'mutual_sincerity', label: '🤝 Mutual sincerity' },
        { value: 'building_trust', label: '🌿 Building trust naturally' }
      ]
    },
    {
      id: 'modern_dating_view',
      type: 'multiple-choice',
      question: '🌍 What feels hardest about modern dating?',
      options: [
        { value: 'not_genuine', label: '🎭 People not being genuine' },
        { value: 'too_fast', label: '⚡ Everything moving too fast' },
        { value: 'emotional_games', label: '🫥 Fear of emotional games' },
        { value: 'finding_connection', label: '💭 Finding people who actually want connection' }
      ]
    },
    {
      id: 'relationship_hopes',
      type: 'text',
      question: '💝 What are you hoping to experience in a relationship for the first time?',
      placeholder: 'Share what you\'re hoping to feel or discover in a relationship…'
    }
  ];
...
<div class="untouched-heart-intent-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      <h2 class="title">
        {step === 'questions' ? 'Openness & Intent' : 'Review Your Answers'}
      </h2>
      <p class="subtitle">
        {step === 'questions'
...
<style>
  ...
  @media (max-width: 767px) {
    .untouched-heart-intent-step { gap: 1rem; }
