  ...
  const questions: Question[] = [
    {
      ...
      options: [
        { value: 'ready_to_love', label: '❤️ Ready to love again' },
        { value: 'stability_companionship', label: '🧱 Looking for emotional stability and companionship' },
        { value: 'open_to_remarriage', label: '💍 Open to remarriage with the right person' },
        { value: 'meaningful_new_chapter', label: '✨ Seeking a meaningful new chapter' }
      ]
    },
    {
      id: 'past_growth',
      type: 'multiple-choice',
      question: '🪞 What has past experience taught you most about relationships?',
      options: [
        { value: 'communication_matters', label: '💬 Communication matters more than chemistry alone' },
        { value: 'consistency_effort', label: '🤝 Consistency and effort matter most' },
        { value: 'peace_over_intensity', label: '🧘 Peace is more valuable than intensity' },
        { value: 'emotional_safety', label: '❤️ Emotional safety changes everything' }
      ]
    },
    {
      id: 'relationship_pace',
      type: 'multiple-choice',
      question: '⏳ What pace feels right for you now?',
      options: [
        { value: 'slow_intentional', label: '🌱 Slow and intentional' },
        { value: 'natural_pressure_free', label: '😊 Natural and pressure-free' },
        { value: 'emotionally_connected_first', label: '❤️ Emotionally connected before commitment' },
        { value: 'open_to_commitment', label: '💍 Open to commitment if things align well' }
      ]
    },
    {
      id: 'current_priorities',
      type: 'multiple-choice',
      question: '⚖️ What matters most to you in this phase of life?',
      options: [
        { value: 'peaceful_partnership', label: '🏡 Building a peaceful partnership' },
        { value: 'emotional_companionship', label: '❤️ Emotional companionship' },
        { value: 'stability_loved_ones', label: '👨‍👩‍👧‍👦 Stability for myself and loved ones' },
        { value: 'emotionally_mature_partner', label: '🌍 Sharing life with someone emotionally mature' }
      ]
    },
    {
      id: 'lessons_learned',
      type: 'text',
      question: '✍️ What\'s one thing you understand about love now that you didn\'t before?',
      placeholder: 'Share what experience has taught you about love…'
    }
  ];
...
<div class="second-chapter-intent-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      <h2 class="title">
        {step === 'questions' ? 'Reflection & Readiness' : 'Review Your Answers'}
      </h2>
      <p class="subtitle">
        {step === 'questions'
...
<style>
  ...
  @media (max-width: 767px) {
    .second-chapter-intent-step { gap: 1rem; }
