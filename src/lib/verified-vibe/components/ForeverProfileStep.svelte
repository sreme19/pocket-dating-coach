<script lang="ts">
  ...
  const questions: Question[] = [
    {
      id: 'current_relationship_intent',
      type: 'multiple-choice',
      question: '❤️ How would you describe yourself right now?',
      options: [
        { value: 'dating_for_marriage', label: '💍 Intentionally dating for marriage' },
        { value: 'long_term', label: '🌱 Looking for a meaningful long-term relationship' },
        { value: 'open_minded_serious', label: '🧭 Open-minded but serious' },
        { value: 'compatibility_first', label: '🤝 Exploring deep compatibility first' }
      ]
    },
    {
      id: 'career_identity',
      type: 'multiple-choice',
      question: '🚀 Which best describes your relationship with work?',
      options: [
        { value: 'career_driven', label: '🎯 Career-driven and ambitious' },
        { value: 'work_life_balance', label: '⚖️ Work-life balance matters most' },
        { value: 'flexible_lifestyle', label: '🌍 Flexible lifestyle over career status' },
        { value: 'passion_focused', label: '💡 Passion-focused over titles or money' }
      ]
    },
    {
      id: 'life_priorities',
      type: 'multi-select',
      question: '🌿 What matters most in your life today?',
      subtitle: 'Select all that apply',
      options: [
        { value: 'emotional_connection', label: '❤️ Emotional connection' },
        { value: 'family', label: '👨‍👩‍👧‍👦 Family & close relationships' },
        { value: 'personal_growth', label: '🧠 Personal growth' },
        { value: 'travel', label: '✈️ Travel & experiences' },
        { value: 'health', label: '💪 Health & wellness' },
        { value: 'career_ambition', label: '🎯 Career ambition' },
        { value: 'stability', label: '🏡 Stability & building a future together' }
      ]
    },
    {
      ...
      options: [
        { value: 'calm_discussions', label: '🧘 Calm discussions' },
        { value: 'need_space', label: '💭 Need space before talking' },
        { value: 'direct_honesty', label: '❤️ Prefer direct honesty immediately' },
        { value: 'resolution_focused', label: '🤝 I focus on finding resolution together' }
      ]
    },
    {
      id: 'relationship_energy',
      type: 'multiple-choice',
      question: '✨ What kind of relationship energy are you looking for?',
      options: [
        { value: 'soft_supportive', label: '🫶 Soft & emotionally supportive' },
        { value: 'passionate', label: '🔥 Passionate & exciting' },
        { value: 'stable_dependable', label: '🧱 Stable & dependable' },
        { value: 'independent_connected', label: '🌍 Independent but connected' }
      ]
    }
  ];
...
<div class="forever-profile-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      <h2 class="title">
        {step === 'questions' ? 'About You' : 'Review Your Profile'}
      </h2>
      <p class="subtitle">
        {step === 'questions'
          ? 'Help your match understand who you are'
