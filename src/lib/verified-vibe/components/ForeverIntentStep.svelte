  ...
  const questions: Question[] = [
    {
      ...
      question: '💫 What kind of relationship are you ultimately hoping for?',
      options: [
        { value: 'marriage_eventually', label: '💍 Marriage eventually' },
        { value: 'long_term_partnership', label: '🏡 Long-term partnership' },
        { value: 'serious_first', label: '🌱 Serious relationship first, then see where it goes' },
        { value: 'open_to_commitment', label: '🤝 Open to commitment with the right person' }
      ]
    },
    {
      id: 'relationship_style',
      type: 'multiple-choice',
      question: '🧭 What relationship style feels right to you?',
      options: [
        { value: 'traditional', label: '❤️ Traditional dating leading to marriage' },
        { value: 'open_cohabitation', label: '🏠 Open to living together before marriage' },
        { value: 'independent_committed', label: '🌍 Independent but deeply committed' },
        { value: 'figuring_out', label: '🤷 Still figuring out what works for me' }
      ]
    },
    {
      ...
      options: [
        ...
        { value: 'reliability_presence', label: '🤝 Reliability & presence' },
        { value: 'passion_chemistry', label: '🔥 Passion & chemistry' }
      ]
    },
    {
      id: 'life_stage_alignment',
      type: 'multiple-choice',
      question: '⏳ What stage of life are you in right now?',
      options: [
        { value: 'building_career', label: '🚀 Building my career and future' },
        { value: 'ready_to_settle', label: '🏡 Ready to settle down soon' },
        { value: 'balancing', label: '⚖️ Balancing ambition and personal life' },
        { value: 'exploring', label: '🌱 Exploring what truly matters to me' }
      ]
    },
    {
      id: 'non_negotiables',
      type: 'text',
      question: '🚫 What are your non-negotiables in a long-term relationship?',
      placeholder: 'Share what you can\'t compromise on…'
    }
  ];
...
<div class="forever-intent-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      <h2 class="title">
        {step === 'questions' ? 'Relationship Intent' : 'Review Your Answers'}
      </h2>
      <p class="subtitle">
        {step === 'questions'
