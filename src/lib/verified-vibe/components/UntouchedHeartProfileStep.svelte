  ...
  const questions: Question[] = [
    {
      ...
      question: '🌿 Which describes you best in relationships?',
      options: [
        { value: 'thoughtful_observant', label: '😊 Thoughtful and observant' },
        { value: 'soft_hearted', label: '❤️ Soft-hearted and sincere' },
        { value: 'loyal_once_trust', label: '🤝 Loyal once I trust someone' },
        { value: 'slow_genuine', label: '🌱 Slow to open up, but genuine' }
      ]
    },
    {
      id: 'emotional_style',
      type: 'multiple-choice',
      question: '🫶 How do you usually connect with people emotionally?',
      options: [
        { value: 'deep_conversations', label: '💬 Through deep conversations' },
        { value: 'comfort_consistency', label: '😊 Through comfort and consistency' },
        { value: 'slowly_over_time', label: '🌿 Slowly over time' },
        { value: 'trust_emotional_safety', label: '❤️ Through trust and emotional safety' }
      ]
    },
    {
      ...
      options: [
        { value: 'emotional_honesty', label: '❤️ Emotional honesty' },
        { value: 'loyalty', label: '🤝 Loyalty' },
        { value: 'communication', label: '💬 Communication' },
        { value: 'patience_understanding', label: '🌱 Patience and understanding' },
        { value: 'kindness', label: '😊 Kindness' },
        { value: 'feeling_emotionally_safe', label: '🫶 Feeling emotionally safe' },
        { value: 'growing_together', label: '🌍 Growing together naturally' }
      ]
    },
    {
      id: 'comfort_zone',
      type: 'multiple-choice',
      question: '🌙 What kind of relationship environment helps you open up most?',
      options: [
        { value: 'calm_pressure_free', label: '😊 Calm and pressure-free' },
        { value: 'warm_affectionate', label: '❤️ Warm and affectionate' },
        { value: 'emotionally_expressive', label: '💬 Emotionally expressive' },
        { value: 'slow_naturally_developing', label: '🌱 Slow and naturally developing' }
      ]
    },
    {
      ...
      options: [
        { value: 'gentle_emotionally_safe', label: '❤️ Gentle and emotionally safe' },
        { value: 'slow_burn_meaningful', label: '🌱 Slow-burn and meaningful' },
        { value: 'comfortable_natural', label: '😊 Comfortable and natural' },
        { value: 'deep_sincere', label: '✨ Deep and sincere' }
      ]
    }
  ];
...
<div class="untouched-heart-profile-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      ...
      <p class="subtitle">
        {step === 'questions'
          ? 'Share how you connect and what you value'
...
<style>
  ...
  @media (max-width: 767px) {
    .untouched-heart-profile-step { gap: 1rem; }
