<script lang="ts">
  ...
  const questions: Question[] = [
    {
      id: 'love_language_energy',
      type: 'multiple-choice',
      question: '❤️ What makes you feel most loved in a relationship?',
      options: [
        { value: 'deep_conversations', label: '🫶 Deep emotional conversations' },
        { value: 'affection_reassurance', label: '💌 Consistent affection & reassurance' },
        { value: 'quality_time', label: '⏳ Quality time together' },
        { value: 'romantic_gestures', label: '🌹 Romantic gestures & effort' }
      ]
    },
    {
      ...
      options: [
        { value: 'deep_emotional', label: '❤️ A deep emotional connection' },
        { value: 'passionate_romance', label: '🔥 Passionate romance' },
        { value: 'safe_stable', label: '🧱 A safe and stable partnership' },
        { value: 'meaningful_growth', label: '🌱 Something meaningful that grows naturally' }
      ]
    },
    {
      id: 'dating_energy',
      type: 'multiple-choice',
      question: '🥀 Which dating energy feels most like you?',
      options: [
        { value: 'fall_deeply', label: '💌 I fall deeply when I truly connect' },
        { value: 'emotional_intimacy', label: '🌊 I love emotional intimacy and closeness' },
        { value: 'romance_special', label: '✨ I want romance that feels special' },
        { value: 'connection_over_status', label: '🫶 I care more about connection than status' }
      ]
    },
    {
      id: 'emotional_presence',
      type: 'multiple-choice',
      question: '🌙 What matters most when you\'re with someone?',
      options: [
        { value: 'emotionally_understood', label: '💬 Feeling emotionally understood' },
        { value: 'consistency_effort', label: '🤝 Consistency and effort' },
        { value: 'warmth_affection', label: '😊 Warmth, affection, and softness' },
        { value: 'undeniable_chemistry', label: '🔥 Chemistry that feels undeniable' }
      ]
    },
    {
      id: 'heartbreak_view',
      type: 'text',
      question: '✍️ What has love taught you so far?',
      placeholder: 'Share what love has meant to you and what you\'ve learned…'
    }
  ];
...
<div class="romantic-intent-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      <h2 class="title">
        {step === 'questions' ? 'Love & Connection' : 'Review Your Answers'}
      </h2>
      <p class="subtitle">
        {step === 'questions'
