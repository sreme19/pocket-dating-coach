<script lang="ts">
  ...
  const questions: Question[] = [
    {
      id: 'attachment_energy',
      type: 'multiple-choice',
      question: '🫀 How do you usually show love?',
      options: [
        { value: 'words_reassurance', label: '💌 Through words and reassurance' },
        { value: 'affection_closeness', label: '🧸 Through affection and closeness' },
        { value: 'consistency_loyalty', label: '🤝 Through consistency and loyalty' },
        { value: 'romantic_gestures', label: '🌹 Through thoughtful romantic gestures' }
      ]
    },
    {
      id: 'ideal_connection',
      ...
      options: [
        { value: 'best_friends_love', label: '🫶 Best friends who fall in love' },
        { value: 'intense_chemistry', label: '🔥 Intense chemistry and romance' },
        { value: 'slow_burn', label: '🌱 Slow-burn emotional intimacy' },
        { value: 'safe_effortless', label: '❤️ A relationship that feels safe and effortless' }
      ]
    },
    {
      id: 'relationship_values',
      type: 'multi-select',
      question: '🌿 What matters most to you in love?',
      ...
      options: [
        ...
        { value: 'romance_effort', label: '🌹 Romance & effort' },
        { value: 'emotional_intelligence', label: '🧠 Emotional intelligence' },
        { value: 'mutual_obsession', label: '✨ Mutual obsession in a healthy way' }
      ]
    },
    {
      id: 'conflict_style',
      type: 'multiple-choice',
      question: '💬 When relationships get difficult, what do you value most?',
      options: [
        { value: 'calm_communication', label: '🧘 Calm communication' },
        { value: 'reassurance_repair', label: '🤝 Reassurance and repair' },
        { value: 'space_before_reconnect', label: '💭 Space before reconnecting' },
        { value: 'work_through_together', label: '❤️ Working through things together' }
      ]
    },
    {
      id: 'romantic_energy',
      ...
      options: [
        { value: 'soft_affectionate', label: '💌 Soft-hearted and affectionate' },
        { value: 'passionate_expressive', label: '🔥 Passionate and expressive' },
        { value: 'loyal_dependable', label: '🫶 Loyal and emotionally dependable' },
        { value: 'idealistic', label: '✨ Idealistic about love' }
      ]
    }
  ];
...
<div class="romantic-profile-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      ...
      <p class="subtitle">
        {step === 'questions'
          ? 'Help your match understand how you love'
...
<style>
  ...
  @media (max-width: 767px) {
    .romantic-profile-step { gap: 1rem; }
