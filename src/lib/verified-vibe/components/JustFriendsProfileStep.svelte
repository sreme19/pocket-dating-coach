  ...
  const questions: Question[] = [
    {
      ...
      question: '💬 What are you usually like in conversations?',
      options: [
        { value: 'warm_easygoing', label: '😊 Warm and easygoing' },
        { value: 'thoughtful_curious', label: '🧠 Thoughtful and curious' },
        { value: 'playful_humorous', label: '😂 Playful and humorous' },
        { value: 'quiet_deeper_over_time', label: '🌿 Quiet at first, deeper over time' }
      ]
    },
    {
      id: 'social_battery',
      type: 'multiple-choice',
      question: '🔋 What kind of social energy fits you best?',
      options: [
        { value: 'small_circles', label: '🌙 Small circles and meaningful conversations' },
        { value: 'meeting_lots', label: '🌍 Meeting lots of different people' },
        { value: 'balanced', label: '😊 Balanced between alone time and social time' },
        { value: 'few_genuine', label: '💬 A few people I genuinely connect with' }
      ]
    },
    {
      id: 'friendship_values',
      type: 'multi-select',
      question: '✨ What matters most to you in friendship?',
      subtitle: 'Select all that apply',
      options: [
        { value: 'loyalty', label: '🤝 Loyalty' },
        { value: 'honest_communication', label: '💬 Honest communication' },
        { value: 'comfort_ease', label: '😊 Comfort and ease' },
        { value: 'shared_humor', label: '😂 Shared humor' },
        { value: 'emotional_support', label: '🌱 Emotional support' },
        { value: 'shared_experiences', label: '🌍 Shared experiences' },
        { value: 'accepted_without_pressure', label: '🫶 Feeling accepted without pressure' }
      ]
    },
    {
      id: 'hangout_style',
      type: 'multiple-choice',
      question: '🌆 What kind of time together sounds most enjoyable?',
      options: [
        { value: 'long_conversations', label: '☕ Long conversations over coffee' },
        { value: 'fun_activities', label: '🎮 Fun activities or hobbies' },
        { value: 'exploring_new_places', label: '🌍 Exploring new places together' },
        { value: 'quiet_low_pressure', label: '🏡 Quiet, low-pressure company' }
      ]
    },
    {
      ...
      options: [
        { value: 'loyal_dependable', label: '🤝 Loyal and dependable' },
        { value: 'emotionally_supportive', label: '💬 Emotionally supportive' },
        { value: 'fun_uplifting', label: '😂 Fun and uplifting' },
        { value: 'calm_easy', label: '🌱 Calm and easy to be around' }
      ]
    }
  ];
...
<div class="just-friends-profile-step">
  <div class="header" transition:fade={{ duration: 200 }}>
    <div class="header-content">
      ...
      <p class="subtitle">
        {step === 'questions'
          ? 'Share your social style and what you enjoy'
...
<style>
  ...
  @media (max-width: 767px) {
    .just-friends-profile-step { gap: 1rem; }
