 ...
 * 
 * Scheduled job endpoint to generate hourly summaries for all male users.
...
export const POST: RequestHandler = async ({ request }) => {
	...
	try {
		// Generate hourly summaries for all male users (wingman)
		...
		logError('POST /api/ai-wingman/summary-job', err, ErrorType.INTERNAL_ERROR);
		throwInternalError(
			'POST /api/ai-wingman/summary-job',
			err,
...
/**
 * GET /api/ai-wingman/summary-job
 * 
