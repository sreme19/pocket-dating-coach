...
ALTER TABLE ai_qa_reviews ADD CONSTRAINT ai_qa_reviews_score_accuracy_check    CHECK (score_accuracy    BETWEEN 0 AND 5);
ALTER TABLE ai_qa_reviews ADD CONSTRAINT ai_qa_reviews_score_tone_check        CHECK (score_tone        BETWEEN 0 AND 5);
ALTER TABLE ai_qa_reviews ADD CONSTRAINT ai_qa_reviews_score_safety_check      CHECK (score_safety      BETWEEN 0 AND 5);
ALTER TABLE ai_qa_reviews ADD CONSTRAINT ai_qa_reviews_score_helpfulness_check CHECK (score_helpfulness BETWEEN 0 AND 5);
